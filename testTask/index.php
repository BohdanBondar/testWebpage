							...
							<div id="content" align="center">
								<div id="log-form">
									...
									<div class="form" id="logup">
										<form action="controllers/php/registration.php" name="logup" method="POST" accept-charset="utf-8" id="form-registration">
											<label for="input-type-input-email">E-mail *</label>
											<input type="email" name="email" placeholder="Email" class="form-input-type1" id ="input-type-input-email" autocomplete="email" maxlength="90" 
												<?php if($_SESSION[ 'email']) echo 'value="'.$_SESSION[ 'email ']. '"'; ?>  onkeyup="this.style.backgroundColor = 'rgb(241, 241, 241)'" minlength="5" tabindex="1" required>
												<label for="input-type-input-login">Login *</label>
												<input type="text" name="login" placeholder="Login" class="form-input-type1" id ="input-type-input-login" autocomplete="nickname" maxlength="30" 
													<?php if($_SESSION[ 'login']) echo 'value="'.$_SESSION[ 'login']. '"'; ?>  onkeyup="this.style.backgroundColor = 'rgb(241, 241, 241)'" minlength="3" tabindex="2" required>
													<label for="input-type-input-name">Real full name *</label>
													<input type="text" name="name" placeholder="Real name" class="form-input-type1" id ="input-type-input-name" autocomplete="name" maxlength="90" 
														<?php if($_SESSION[ 'name']) echo 'value="'.$_SESSION[ 'name']. '"'; ?> onkeyup="this.style.backgroundColor = 'rgb(241, 241, 241)'" minlength="3" tabindex="3" required>
														<label for="input-type-input-password">Create a password *</label>
														<input type="password" name="pass" placeholder="Password" class="form-input-type1" id ="input-type-input-password"  maxlength="90" minlength="5" tabindex="4" onkeydown="if (event.keyCode == 32) {return false;}" onkeyup=" this.style.backgroundColor = 'rgb(241, 241, 241)'; checkPassword()" required>
																...
																<input type="number" name="birthday"  class="form-input-type2" id ="input-type-input-date-day"  autocomplete="bday-day" max="31" min="1" value = "
																	...
																	<input type="number" name="birthmonth"  class="form-input-type2" id ="input-type-input-date-month" autocomplete="bday-month" max="12" min="1" value="
																		...
																		<div class="form-input-type3" align="left">
																			...
																			<form action="controllers/php/login.php" name="Login" method="POST" accept-charset="utf-8" id="form-login">
																				<label for="input-type-first">Enter E-mail or Login *</label>
																				<input type="text" name="first" placeholder="Email or login" class="form-input-type1" id="input-type-first" 
																					<?php if($_SESSION[ 'login-first']) echo 'value=" '.$_SESSION[ 'login-first ']. ' "'; ?> autocomplete="email" maxlength="90" onkeyup="this.style.backgroundColor='rgb(241, 241, 241)'" minlength="2" tabindex="1" required>
																					<label for="input-type-password">Enter password *</label>
																					<input type="password" name="pass" placeholder="Password" class="form-input-type1" id="input-type-password" 
																						<?php if($_SESSION[ 'passwordLogin']) echo 'value=" '.$_SESSION[ 'passwordLogin ']. ' "'; ?> maxlength="90" minlength="5" tabindex="4" onkeydown="if (event.keyCode==3 2) {return false;}" required>
																						<div class="form-input-type3" align="left">
